...
def allen_break_json() -> bool:
    ...
    for filen, path in paths.items():
        with open(path, "r") as data_f:
            ...
            train_data = {
                "data": data_f_json["train"]
            }
            val_data = {
                "data": data_f_json["val"]
            }
            test_data = {
                "data": data_f_json["test"]
            }

            if begin == "data":
                train_data["data"] += data_f_json["oos_train"]
                val_data["data"] += data_f_json["oos_val"]
                test_data["data"] += data_f_json["oos_test"]
